...
DB_FILE = os.path.join("data", "archive.db")  # SQLite state store (source of truth)
...
# Sync engine: worker concurrency + client-side Cobalt rate limit.
CONCURRENCY = 4          # simultaneous item workers
RATE_MAX_CALLS = 8       # at most this many Cobalt calls...
RATE_PERIOD = 1.0        # ...per this many seconds
