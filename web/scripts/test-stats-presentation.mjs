...
assert.equal(lib.compactCount(1250000000), "1.3B");
assert.equal(lib.coveragePercent(3, 4), 75);
assert.equal(lib.coveragePercent(9, 4), 100);
assert.equal(lib.coveragePercent(1, 0), 0);
